...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Vui lòng điền tên của bạn.\n';
    }

    if(empty($_POST['visitor_phone']))
    {
        $valid = 0;
        $error_message .= 'Vui lòng điền số điện thoại của bạn.\n';
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Vui lòng điền email của bạn.\n';
    }
    else
    {
        ...
        {
            $valid = 0;
            $error_message .= 'Vui lòng điền địa chỉ email hợp lệ.\n';
        }
    }
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="visitor_email" placeholder="Nhập email">
                                    </div>
                                    <div class="form-group">
