...
if(isset($_POST['form_add_to_cart'])) {
	...
	if($_POST['p_qty'] > $current_p_qty):
		$temp_msg = 'Rất tiếc! Chỉ có '.$current_p_qty.' mặt hàng trong kho';
		?>
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'Sản phẩm này đã được thêm vào giỏ hàng.';
            ...
            $success_message1 = 'Sản phẩm được thêm vào giỏ hàng thành công!';
        }
                                    ...
                                    <div class="review-form">
                                        ...
                                        <?php if(isset($_SESSION['customer'])): ?>
                                            ...
                                            <div class="form-group">
                                                <textarea name="comment" class="form-control" cols="30" rows="10" placeholder="Viết bình luận của bạn (tùy chọn)" style="height:100px;"></textarea>
                                            </div>
