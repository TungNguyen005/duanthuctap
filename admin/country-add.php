...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_name'])) {
        $valid = 0;
        $error_message .= "Tên thành phố không được để trống<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Tên thành phố đã tồn tại<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Thành phố đã được thêm thành công.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="country.php" class="btn btn-primary btn-sm">Xem toàn bộ</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Tên thành phố<span>*</span></label>
							<div class="col-sm-4">
