...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['title'])) {
		$valid = 0;
		$error_message .= 'Tiêu đề không thể để trống<br>';
	}

	if(empty($_POST['content'])) {
		$valid = 0;
		$error_message .= 'Nội dung không thể để trống<br>';
	}
	...
	if($valid == 1) {
	    ...
	    $success_message = 'Dịch vụ được cập nhật thành công!';
	}
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="service.php" class="btn btn-primary btn-sm">Xem toàn bộ</a>
	</div>
</section>
