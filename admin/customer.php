					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						<thead>
							<tr>
								...
								<th width="180">Thành phố</th>
								<th>Trạng thái</th>
								<th width="100">Chuyển trạng thái</th>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr class="<?php if($row['cust_status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									...
									<td>
										<a href="customer-change-status.php?id=<?php echo $row['cust_id']; ?>" class="btn btn-success btn-xs">Chuyển trạng thái</a>
									</td>
									<td>
