...
if(isset($_POST['form_about'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Trang Giới Thiệu Thông Tin được cập nhật thành công.';
...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Thông tin trang FAQ được cập nhật thành công.';
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Trang nội dung * </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Miêu tả Meta</label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_2">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Baner mới</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
