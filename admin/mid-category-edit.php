...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "Hãng sản phẩm không được để trống<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Hãng sản phẩm được cập nhật thành công.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Sửa hàng sản phẩm</h1>
	</div>
	<div class="content-header-right">
		<a href="mid-category.php" class="btn btn-primary btn-sm">Xem toàn bộ</a>
	</div>
</section>
