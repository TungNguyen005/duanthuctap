...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['caption'])) {
        $valid = 0;
        $error_message .= "Chú thích ảnh không được để trống<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Ảnh được thêm thành công.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="photo.php" class="btn btn-primary btn-sm">Xem toàn bộ</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Tải ảnh<span>*</span></label>
